...
namespace graphs{
	void tree(int n, int diameter, bool weighted = 0, int lb_weight = 0, int ub_weight = 0){
		_
	...
	void functional_graph(int n, bool weighted = 0, int lb_weight = 0, int ub_weight = 0){
		_ // possible self loops
			int perm[n];
	...
	void raw_graph(int n, int m, bool weighted = 0, int lb_weight = 0, int ub_weight = 0){
		_ // possible edge repeats, cycles, self loops
			if (output_file == "none"){
				cout << n << " " << m << endl;
				for (int i = 0; i < m; i++){
	...
	void clean_graph(int n, int m, bool weighted = 0, int lb_weight = 0, int ub_weight = 0){
		_ // no edge repeats or self loops
	...
	void dag(int n, int m, bool weighted = 0, int lb_weight = 0, int ub_weight = 0){
		_
